...
> Snapshot 1
    ...
    ␊
    Options:␊
      --premint <string>                    The number of tokens to premint for the deployer. Cannot be used with the wrappable extension, since preminted tokens would not be backed by the underlying token.␊
