...
> Snapshot 1
    ...
    ␊
    Options:␊
      --decimals <string>                   The number of decimals used to represent token amounts. Defaults to 6. Incompatible with wrappable, which derives its decimals from the underlying token (capped at 6).␊
