...
> Snapshot 1
    ...
    `stellar-account: Make a smart account (smart wallet) that authorizes operations through configurable signers and policies, for example a multisig with passkey, Ed25519 and delegated signers.␊
    ␊
    Required:␊
      --name <string>                       The name of the contract␊
    ␊
