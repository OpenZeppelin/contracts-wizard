...
> Snapshot 1
    ...
    ␊
        function _getUnspecifiedAmount(SwapParams calldata params)␊
            ...
            returns (uint256)␊
        {␊
            // Override _getUnspecifiedAmount␊
        }␊
    ␊
...
> Snapshot 1
    ...
    ␊
        function poke(PoolKey calldata key) public override {␊
            // Override poke␊
        }␊
    }␊
    `
