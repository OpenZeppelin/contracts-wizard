...
import {
    printERC777,
    defaults as erc777defaults,
    isAccessControlRequired as erc777IsAccessControlRequired,
    ERC777Options,
} from "./erc777";
import {
    printERC721,
...
export type ERC777 = WizardContractAPI<ERC777Options>;
...
export const erc777: ERC777 = {
    print: printERC777,
    defaults: erc777defaults,
    isAccessControlRequired: erc777IsAccessControlRequired,
};
