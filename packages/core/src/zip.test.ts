...
test('erc721 auto increment uups', t => {
  ...
  t.deepEqual(files, [
    ...
    '@openzeppelin/contracts-upgradeable/interfaces/draft-IERC6093Upgradeable.sol',
    '@openzeppelin/contracts-upgradeable/proxy/',
    '@openzeppelin/contracts-upgradeable/proxy/ERC1967/',
    '@openzeppelin/contracts-upgradeable/proxy/ERC1967/ERC1967UtilsUpgradeable.sol',
