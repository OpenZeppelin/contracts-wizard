...
> Snapshot 1
    ...
    // Compatible with OpenZeppelin Contracts for Cairo ^4.0.1␊
    ␊
    #[starknet::contract]␊
    mod MyToken {␊
...
> Snapshot 1
    ...
    mod MyToken {␊
        ...
        use openzeppelin_token::erc20::extensions::erc20_flash_mint::{␊
        	DefaultConfig as ERC20FlashMintDefaultConfig, ERC20FlashMintComponent␊
        };␊
        use openzeppelin_upgrades::UpgradeableComponent;␊
        use starknet::{ClassHash, ContractAddress};␊
    ␊
        component!(path: ERC20Component, storage: erc20, event: ERC20Event);␊
        component!(path: ERC20FlashMintComponent, storage: erc20_flash_mint, event: ERC20FlashMintEvent);␊
        component!(path: UpgradeableComponent, storage: upgradeable, event: UpgradeableEvent);␊
        component!(path: OwnableComponent, storage: ownable, event: OwnableEvent);␊
    ␊
        // External␊
    ...
    ␊
        ...
        struct Storage {␊
            ...
            erc20: ERC20Component::Storage,␊
            #[substorage(v0)]␊
            erc20_flash_mint: ERC20FlashMintComponent::Storage,␊
            #[substorage(v0)]␊
            upgradeable: UpgradeableComponent::Storage,␊
            #[substorage(v0)]␊
            ownable: OwnableComponent::Storage,␊
...
## erc20 flash mint with custom max
    ...
    ␊
        impl FlashMintConfigImpl of ERC20FlashMintComponent::FlashMintConfigTrait<ContractState> {␊
            fn max_flash_loan(␊
                ...
                let cap: u256 = 1000000000000000000000000;␊
...
## erc20 flash mint with percent fee
...
## erc20 flash mint with fractional percent fee
...
## erc20 flash mint with percent fee and fee receiver
...
> Snapshot 1
    ...
    ␊
        #[storage]␊
        struct Storage {␊
            flash_fee_receiver: ContractAddress,␊
            #[substorage(v0)]␊
            erc20: ERC20Component::Storage,␊
            #[substorage(v0)]␊
            erc20_flash_mint: ERC20FlashMintComponent::Storage,␊
    ...
    ␊
        ...
        fn constructor(␊
            ...
            self.ownable.initializer(owner);␊
    ␊
            assert(!flash_fee_receiver.is_zero(), 'FlashMint: invalid receiver');␊
            self.flash_fee_receiver.write(flash_fee_receiver);␊
        }␊
    ␊
        impl FlashMintConfigImpl of ERC20FlashMintComponent::FlashMintConfigTrait<ContractState> {␊
            fn flash_fee(␊
    ...
    ␊
            fn flash_fee_receiver(self: @ERC20FlashMintComponent::ComponentState<ContractState>) -> ContractAddress {␊
                self.get_contract().flash_fee_receiver.read()␊
            }␊
        }␊
    ␊
        //␊
...
## erc20 flash mint with custom fee impl
    ...
    ␊
        impl FlashMintConfigImpl of ERC20FlashMintComponent::FlashMintConfigTrait<ContractState> {␊
            fn flash_fee(␊
                ...
                // TODO: Must be implemented according to the desired flash fee logic;␊
                0␊
            }␊
        }␊
    ␊
...
## erc20 flash mint with all custom config
...
## erc20 flash mint with max amount of zero
