...
> Snapshot 1
    ...
    ␊
    #[starknet::contract]␊
    #[with_components(ERC20, ERC20Wrapper, Upgradeable, Ownable)]␊
    mod MyToken {␊
        use openzeppelin_interfaces::upgrades::IUpgradeable;␊
        use openzeppelin_token::erc20::{DefaultConfig as ERC20DefaultConfig, ERC20HooksEmptyImpl};␊
        use starknet::{ClassHash, ContractAddress};␊
...
> Snapshot 1
    ...
    ␊
    #[starknet::contract]␊
    #[with_components(ERC20, ERC20FlashMint, Upgradeable, Ownable)]␊
    mod MyToken {␊
        use openzeppelin_interfaces::upgrades::IUpgradeable;␊
        use openzeppelin_token::erc20::{DefaultConfig as ERC20DefaultConfig, ERC20HooksEmptyImpl};␊
        use openzeppelin_token::erc20::extensions::erc20_flash_mint::DefaultConfig as ERC20FlashMintDefaultConfig;␊
        use starknet::{ClassHash, ContractAddress};␊
    ␊
        // External␊
        #[abi(embed_v0)]␊
