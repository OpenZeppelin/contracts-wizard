...
test("API isAccessControlRequired", async (t) => {
  t.is(
    erc1155.isAccessControlRequired({ updatableUri: false, mintable: true }),
    true,
  );
  t.is(
    erc1155.isAccessControlRequired({ updatableUri: false, pausable: true }),
    true,
  );
  t.is(
    erc1155.isAccessControlRequired({ updatableUri: false, upgradeable: true }),
    true,
  );
