...
// Isolated Hardhat config for TRON compile tests so they do not share
// sources/cache/artifacts with the mainline `hardhat.config.js` compile tests.
