...
> Snapshot 1
    ...
    ␊
        function initialize(address signer) public {␊
...
> Snapshot 1
    ...
    ␊
        function initialize(bytes32 qx, bytes32 qy) public {␊
...
> Snapshot 1
    ...
    ␊
        function initialize(bytes memory e, bytes memory n) public {␊
...
> Snapshot 1
    ...
    ␊
        function initialize(bytes[] memory signers, uint64 threshold) public {␊
