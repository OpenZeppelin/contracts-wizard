...
> Snapshot 1
    ...
    import {AccountERC7579Hooked} from "@openzeppelin/contracts/account/extensions/AccountERC7579Hooked.sol";␊
    import {EIP712} from "@openzeppelin/contracts/utils/cryptography/EIP712.sol";␊
    import {ERC7739} from "@openzeppelin/contracts/utils/cryptography/signers/draft-ERC7739.sol";␊
    import {PackedUserOperation} from "@openzeppelin/contracts/interfaces/draft-IERC4337.sol";␊
    ␊
...
> Snapshot 1
    ...
    ␊
    import {Account} from "@openzeppelin/contracts/account/Account.sol";␊
    import {AccountERC7579Upgradeable} from "@openzeppelin/contracts-upgradeable/account/extensions/AccountERC7579Upgradeable.sol";␊
    import {EIP712} from "@openzeppelin/contracts/utils/cryptography/EIP712.sol";␊
    import {ERC7739} from "@openzeppelin/contracts/utils/cryptography/signers/draft-ERC7739.sol";␊
    import {Initializable} from "@openzeppelin/contracts/proxy/utils/Initializable.sol";␊
    import {PackedUserOperation} from "@openzeppelin/contracts/interfaces/draft-IERC4337.sol";␊
...
> Snapshot 1
    ...
    ␊
    import {Account} from "@openzeppelin/contracts/account/Account.sol";␊
    import {AccountERC7579HookedUpgradeable} from "@openzeppelin/contracts-upgradeable/account/extensions/AccountERC7579HookedUpgradeable.sol";␊
...
> Snapshot 1
    ...
    contract CustomAccountWithSignerECDSA is Initializable, Account, EIP712, ERC7739, SignerECDSAUpgradeable, UUPSUpgradeable {␊
        constructor(address signer) EIP712("CustomAccount with SignerECDSA", "1") {␊
            _disableInitializers();␊
        }␊
    ␊
        function initialize(address signer) public initializer {␊
...
> Snapshot 1
    ...
    contract MyAccount is Initializable, Account, EIP712, ERC7739, SignerECDSAUpgradeable, ERC7821, UUPSUpgradeable {␊
        constructor(address signer) EIP712("MyAccount", "1") {␊
            _disableInitializers();␊
        }␊
    ␊
        function initialize(address signer) public initializer {␊
...
> Snapshot 1
    ...
    pragma solidity ^0.8.27;␊
    ␊
    import {AbstractSignerUpgradeable} from "@openzeppelin/contracts-upgradeable/utils/cryptography/signers/AbstractSignerUpgradeable.sol";␊
    import {Account} from "@openzeppelin/contracts/account/Account.sol";␊
    import {AccountERC7579Upgradeable} from "@openzeppelin/contracts-upgradeable/account/extensions/AccountERC7579Upgradeable.sol";␊
    import {EIP712} from "@openzeppelin/contracts/utils/cryptography/EIP712.sol";␊
    import {ERC7739} from "@openzeppelin/contracts/utils/cryptography/signers/draft-ERC7739.sol";␊
    ...
    ␊
        ...
        function _rawSignatureValidation(bytes32 hash, bytes calldata signature)␊
            internal␊
            view␊
            override(SignerECDSA, AbstractSignerUpgradeable, AccountERC7579Upgradeable)␊
            returns (bool)␊
        {␊
            return super._rawSignatureValidation(hash, signature);␊
        }␊
...
> Snapshot 1
    ...
    contract MyAccount is Initializable, Account, EIP712, ERC7739, SignerP256Upgradeable, ERC7821, UUPSUpgradeable {␊
        constructor(bytes32 qx, bytes32 qy) EIP712("MyAccount", "1") {␊
            _disableInitializers();␊
        }␊
    ␊
        function initialize(bytes32 qx, bytes32 qy) public initializer {␊
...
> Snapshot 1
    ...
    ␊
        ...
        function _rawSignatureValidation(bytes32 hash, bytes calldata signature)␊
            internal␊
            view␊
            override(SignerP256, AbstractSignerUpgradeable, AccountERC7579Upgradeable)␊
            returns (bool)␊
        {␊
            return super._rawSignatureValidation(hash, signature);␊
        }␊
...
> Snapshot 1
    ...
    contract MyAccount is Initializable, Account, EIP712, ERC7739, SignerRSAUpgradeable, ERC7821, UUPSUpgradeable {␊
        constructor(bytes memory e, bytes memory n) EIP712("MyAccount", "1") {␊
            _disableInitializers();␊
        }␊
    ␊
        function initialize(bytes memory e, bytes memory n) public initializer {␊
...
> Snapshot 1
    ...
    ␊
        ...
        function _rawSignatureValidation(bytes32 hash, bytes calldata signature)␊
            internal␊
            view␊
            override(SignerRSA, AbstractSignerUpgradeable, AccountERC7579Upgradeable)␊
            returns (bool)␊
        {␊
            return super._rawSignatureValidation(hash, signature);␊
        }␊
...
> Snapshot 1
    ...
    ␊
        ...
        function _rawSignatureValidation(bytes32 hash, bytes calldata signature)␊
            internal␊
            view␊
            override(MultiSignerERC7913, AbstractSignerUpgradeable, AccountERC7579Upgradeable)␊
            returns (bool)␊
        {␊
            return super._rawSignatureValidation(hash, signature);␊
        }␊
