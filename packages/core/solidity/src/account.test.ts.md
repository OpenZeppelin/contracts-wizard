...
> Snapshot 1
    ...
    ␊
        function create(uint256 moduleTypeId, address module, bytes calldata initData, bytes32 salt)␊
            public␊
            returns (address)␊
        {␊
...
> Snapshot 1
    ...
    ␊
        function create(bytes[] memory signers, uint64 threshold, bytes32 salt)␊
            public␊
            returns (address)␊
        {␊
...
> Snapshot 1
    ...
    ␊
        function create(bytes[] memory signers, uint64[] memory weights, uint64 threshold, bytes32 salt)␊
            public␊
            returns (address)␊
        {␊
