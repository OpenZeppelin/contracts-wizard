...
> Snapshot 1
    ...
    import {Ownable} from "@openzeppelin/contracts/access/Ownable.sol";␊
    ␊
    contract MyToken is ERC20, ERC20Bridgeable, Ownable, ERC20Burnable, ERC20Permit {␊
        address public tokenBridge;␊
        error Unauthorized();␊
    ␊
        constructor(address tokenBridge_, address initialOwner)␊
...
## erc20 crossChainBridging embedded
...
> Snapshot 1
    ...
    import {Ownable} from "@openzeppelin/contracts/access/Ownable.sol";␊
    ␊
    contract MyToken is ERC20, ERC20Crosschain, Ownable, ERC20Permit {␊
        ...
        {}␊
    ␊
        function setLink(address gateway, bytes memory counterpart, bool allowOverride)␊
            public␊
            onlyOwner␊
        {␊
...
## erc20 crossChainBridging embedded ownable
...
## erc20 crossChainBridging embedded ownable mintable burnable
...
> Snapshot 1
    ...
    import {Ownable} from "@openzeppelin/contracts/access/Ownable.sol";␊
    ␊
    contract MyToken is ERC20, ERC20Crosschain, Ownable, ERC20Burnable, ERC20Permit {␊
        constructor(CrosschainLinked.Link[] memory links, address initialOwner)␊
            ERC20("MyToken", "MTK")␊
            CrosschainLinked(links)␊
            Ownable(initialOwner)␊
...
## erc20 crossChainBridging embedded roles
...
> Snapshot 1
    ...
    import {ERC20Permit} from "@openzeppelin/contracts/token/ERC20/extensions/ERC20Permit.sol";␊
    ␊
    contract MyToken is ERC20, ERC20Crosschain, AccessControl, ERC20Permit {␊
...
## erc20 crossChainBridging embedded managed
...
> Snapshot 1
    ...
    import {ERC20Permit} from "@openzeppelin/contracts/token/ERC20/extensions/ERC20Permit.sol";␊
    ␊
    contract MyToken is ERC20, ERC20Crosschain, AccessManaged, ERC20Permit {␊
...
## erc20 crossChainBridging embedded upgradeable
...
> Snapshot 1
    ...
    ␊
    contract MyToken is Initializable, ERC20Upgradeable, ERC20CrosschainUpgradeable, OwnableUpgradeable, ERC20PermitUpgradeable {␊
...
> Snapshot 1
    ...
    import {OwnableUpgradeable} from "@openzeppelin/contracts-upgradeable/access/OwnableUpgradeable.sol";␊
    ␊
    contract MyToken is Initializable, ERC20Upgradeable, ERC20BridgeableUpgradeable, OwnableUpgradeable, ERC20PermitUpgradeable {␊
