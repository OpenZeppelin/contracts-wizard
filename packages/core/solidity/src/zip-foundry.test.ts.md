...
> Snapshot 1
    ...
    [
      ...
      ␊
          ...
          function callMyCustomFunction(uint256 _toChainId) public {␊
              if (_toChainId == block.chainid) revert InvalidDestination();␊
              messenger.sendMessage(_toChainId, address(this), abi.encodeCall(this.myCustomFunction, (/* TODO: Add arguments */)));␊
          }␊
      ␊
          /**␊
...
> Snapshot 1
    ...
    [
      ...
      ␊
          function callMyFunction(uint256 _toChainId) public restricted {␊
              if (_toChainId == block.chainid) revert InvalidDestination();␊
