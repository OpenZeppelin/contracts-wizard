    ...
    [
      ...
      ␊
        ...
        then␊
          ...
          echo "Failed to update remappings.txt. Manually update remappings.txt to add @eth-optimism/contracts-bedrock/ with the same path as @eth-optimism-contracts-bedrock/"␊
          exit 1␊
        fi␊
      ␊
        # Perform initial git commit␊
