...
> Snapshot 1
    ...
    [
      ...
      ␊
        ...
        if [ -n "$OPTIMISM_PATH" ]␊
        then␊
          grep -v '@eth-optimism-contracts-bedrock' remappings.txt > remappings.tmp␊
          echo "@eth-optimism/contracts-bedrock/=$OPTIMISM_PATH" >> remappings.tmp␊
          mv remappings.tmp remappings.txt␊
        else␊
          echo "Failed to setup Optimism dependencies. Run 'forge soldeer install', then update remappings.txt to rename @eth-optimism-contracts-bedrock-^0.17.3/ to @eth-optimism/contracts-bedrock/"␊
          exit 1␊
        fi␊
      ␊
        # Perform initial git commit␊
      ...
      version = "0.17.3"␊
      url = "https://soldeer-revisions.s3.amazonaws.com/@eth-optimism-contracts-bedrock/0_17_3_06-06-2024_05:37:28_contracts-bedrock.zip"␊
      checksum = "cd0264f2f2c9f0278f7f8259f4a2b230897262afe14eb8baef996274e53c23db"␊
      integrity = "7646fa5b18fa27ac5e3de58996a778e2e3675a8d24d3fbf59a889f7397570a73"␊
      `,
      `// SPDX-License-Identifier: MIT␊
      pragma solidity ^0.8.27;␊
      ␊
      ...
      ␊
          ...
          function callMyCustomFunction(uint256 toChainId) public {␊
              if (toChainId == block.chainid) revert InvalidDestination();␊
              messenger.sendMessage(toChainId, address(this), abi.encodeCall(this.myCustomFunction, (/* TODO: Add arguments to match myCustomFunction */)));␊
          }␊
      ␊
          /**␊
           ...
           */␊
          function myCustomFunction(/* TODO: Add arguments */) external onlyCrossDomainCallback {␊
...
## custom transparent, managed, cross chain messaging superchain
...
> Snapshot 1
    ...
    [
      ...
      ␊
          function callMyFunction(uint256 toChainId) public restricted {␊
              if (toChainId == block.chainid) revert InvalidDestination();␊
