    ...
    [
      ...
      ␊
          ...
          function callMyCustomFunction(uint256 toChainId) public {␊
              ...
              messenger.sendMessage(toChainId, address(this), abi.encodeCall(this.myCustomFunction, (/* TODO: Add arguments */)));␊
          }␊
      ␊
          /**␊
    ...
    [
      ...
      ␊
          function callMyFunction(uint256 toChainId) public restricted {␊
              if (toChainId == block.chainid) revert InvalidDestination();␊
              messenger.sendMessage(toChainId, address(this), abi.encodeCall(this.myFunction, (/* TODO: Add arguments */)));␊
          }␊
      ␊
          /**␊
           * @dev IMPORTANT: This function trusts contracts at the same address on other chains.␊
