    ...
    [
      ...
      `{␊
        ...
        "devDependencies": {␊
          ...
          "@openzeppelin/contracts": "5.7.0-rc.0",␊
          "ava": "^6.0.0",␊
          "ethers": "^6.8.1",␊
          "hardhat": "^3.6.0",␊
          "tsx": "^4.7.0",␊
      ...
      ␊
        t.is(await instance.name(), "My Token");␊
      });␊
      `,
    ]
    ...
    [
      ...
      `{␊
        ...
        "devDependencies": {␊
          "@nomicfoundation/hardhat-ethers": "^4.0.2",␊
          "@openzeppelin/contracts": "5.7.0-rc.0",␊
          "@openzeppelin/contracts-upgradeable": "5.7.0-rc.0",␊
      ...
      ␊
        // TODO: Set values for the constructor arguments below␊
        const instance = await upgradesApi.deployProxy(ContractFactory, [tokenBridge_, initialOwner, recipient]);␊
        await instance.waitForDeployment();␊
      ␊
...
> Snapshot 1
    ...
    [
      ...
      ␊
        // TODO: Set values for the constructor arguments below␊
        const instance = await upgradesApi.deployProxy(ContractFactory, [initialOwner]);␊
        await instance.waitForDeployment();␊
      ␊
        console.log(\`Proxy deployed to ${await instance.getAddress()}\`);␊
      }␊
...
> Snapshot 1
    ...
    [
      ...
      ␊
        ...
        await instance.waitForDeployment();␊
      ␊
        t.is(await instance.uri(0), "https://myuri/{id}");␊
      });␊
      `,
    ]
...
> Snapshot 1
    ...
    [
      ...
      ␊
        // TODO: Set values for the constructor arguments below␊
        const myToken = m.contract("MyToken", [links, initialOwner]);␊
      ␊
        return { myToken };␊
      });␊
      `,
      ...
      ␊
        ...
        const links = ...;␊
        const initialOwner = (await ethers.getSigners())[1].address;␊
        const instance = await ContractFactory.deploy(links, initialOwner);␊
        await instance.waitForDeployment();␊
        */␊
      ␊
        t.pass();␊
...
> Snapshot 1
    ...
    [
      ...
      ␊
        // TODO: Set values for the constructor arguments below␊
        const myGovernor = m.contract("MyGovernor", [_token, _timelock]);␊
      ␊
        return { myGovernor };␊
      });␊
      `,
      ...
      test.after.always(() => connection.close());␊
      ␊
      test("MyGovernor", async t => {␊
        const ContractFactory = await ethers.getContractFactory("MyGovernor");␊
      ␊
        // TODO: Set values for the variables below, then uncomment the following section:␊
        /*␊
        const _token = ...;␊
        const _timelock = ...;␊
        const instance = await ContractFactory.deploy(_token, _timelock);␊
        await instance.waitForDeployment();␊
        */␊
      ␊
        t.pass();␊
...
> Snapshot 1
    ...
    [
      ...
      ␊
        ...
        await instance.waitForDeployment();␊
      ␊
        t.truthy(await instance.getAddress());␊
      });␊
      `,
    ]
...
> Snapshot 1
    ...
    [
      ...
      ␊
        // TODO: Set values for the constructor arguments below␊
        const instance = await upgradesApi.deployProxy(ContractFactory, [signer], { unsafeAllow: ['constructor'] });␊
        await instance.waitForDeployment();␊
      ␊
        console.log(\`Proxy deployed to ${await instance.getAddress()}\`);␊
      }␊
...
> Snapshot 1
    ...
    [
      ...
      ␊
        ␊
        const instance = await upgradesApi.deployProxy(ContractFactory, []);␊
        await instance.waitForDeployment();␊
      ␊
        console.log(\`Proxy deployed to ${await instance.getAddress()}\`);␊
      }␊
...
> Snapshot 1
    ...
    [
      ...
      ␊
        ...
        await instance.waitForDeployment();␊
      ␊
        t.is(await instance.uri(0), "https://example.com/\\"id\\"/{id}");␊
      });␊
      `,
    ]
