...
> Snapshot 1
    ...
    use stellar_tokens::fungible::{Base, FungibleToken, votes::FungibleVotes};␊
    ␊
    #[contract]␊
    pub struct MyToken;␊
    ␊
...
> Snapshot 1
    ...
    use stellar_tokens::fungible::{␊
        Base, burnable::FungibleBurnable, FungibleToken, votes::FungibleVotes␊
    };␊
    ␊
    #[contract]␊
    pub struct MyToken;␊
...
> Snapshot 1
    ...
    impl MyToken {␊
        pub fn __constructor(e: &Env, recipient: Address, owner: Address) {␊
            Base::set_metadata(e, 7, String::from_str(e, "MyToken"), String::from_str(e, "MTK"));␊
            FungibleVotes::mint(e, &recipient, 20000000000);␊
            ownable::set_owner(e, &owner);␊
        }␊
    ␊
        #[only_owner]␊
