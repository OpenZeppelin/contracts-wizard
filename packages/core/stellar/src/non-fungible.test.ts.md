...
> Snapshot 1
    ...
    impl MyToken {␊
        ...
        pub fn __constructor(e: &Env, name: String, symbol: String, uri: String) {␊
...
> Snapshot 1
    ...
    impl MyToken {␊
        ...
        // --uri "https://www.mytoken.com" \\␊
        // --owner <owner_address>␊
        pub fn __constructor(e: &Env, name: String, symbol: String, uri: String, owner: Address) {␊
            Base::set_metadata(e, uri, name, symbol);␊
...
> Snapshot 1
    ...
    impl MyToken {␊
        ...
        // --name MyToken \\␊
        // --symbol MTK \\␊
        // --uri "https://www.mytoken.com/nfts/"␊
        pub fn __constructor(e: &Env, name: String, symbol: String, uri: String) {␊
            Base::set_metadata(e, uri, name, symbol);␊
        }␊
    }␊
