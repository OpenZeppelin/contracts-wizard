...
> Snapshot 1
    ...
    // Compatible with OpenZeppelin Stellar Soroban Contracts ^0.7.0-rc.1␊
    #![no_std]␊
    ␊
...
> Snapshot 1
    ...
    #![no_std]␊
    ␊
    use soroban_sdk::{Address, BytesN, contract, contractimpl, Env, String};␊
    use stellar_access::ownable::{self as ownable, Ownable};␊
...
> Snapshot 1
    ...
    ␊
    use soroban_sdk::{Address, contract, contractimpl, Env, String};␊
    use stellar_governance::votes::{self as votes, Votes};␊
    use stellar_tokens::non_fungible::{Base, NonFungibleToken, votes::NonFungibleVotes};␊
    ␊
    #[contract]␊
    pub struct MyToken;␊
    ␊
...
> Snapshot 1
    ...
    use stellar_governance::votes::{self as votes, Votes};␊
    use stellar_tokens::non_fungible::{␊
        Base, burnable::NonFungibleBurnable, NonFungibleToken, votes::NonFungibleVotes␊
    };␊
    ␊
    #[contract]␊
    pub struct MyToken;␊
...
## non-fungible votes explicit trait implementations
...
> Snapshot 1
    ...
    use stellar_governance::votes::{self as votes, Votes};␊
    use stellar_tokens::non_fungible::{␊
        Base, ContractOverrides, NonFungibleToken, votes::NonFungibleVotes␊
    };␊
    ␊
    #[contract]␊
    pub struct MyToken;␊
    ...
    impl Votes for MyToken {␊
        fn get_votes(e: &Env, account: Address) -> i128 {␊
            votes::get_votes(e, &account)␊
        }␊
    ␊
        fn get_votes_at_checkpoint(e: &Env, account: Address, ledger: u32) -> i128 {␊
            votes::get_votes_at_checkpoint(e, &account, ledger)␊
        }␊
    ␊
        fn get_total_supply(e: &Env) -> i128 {␊
            votes::get_total_supply(e)␊
        }␊
    ␊
        fn get_total_supply_at_checkpoint(e: &Env, ledger: u32) -> i128 {␊
            votes::get_total_supply_at_checkpoint(e, ledger)␊
        }␊
    ␊
        fn get_delegate(e: &Env, account: Address) -> Option<Address> {␊
            votes::get_delegate(e, &account)␊
        }␊
    ␊
