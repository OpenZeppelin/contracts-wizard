...
> Snapshot 1
    ...
    [
      ...
      // Compatible with OpenZeppelin Contracts ^5.7.0-rc.0 and Confidential Contracts ^0.3.1␊
      pragma solidity ^0.8.27;␊
      ␊
      import {ZamaEthereumConfig} from "@fhevm/solidity/config/ZamaConfig.sol";␊
      import {euint64} from "@fhevm/solidity/lib/FHE.sol";␊
      ...
      ␊
          constructor(IERC20 underlying, address defaultAdmin, address handleViewer)␊
      ...
      ␊
        ...
        const myToken = m.contract("MyToken", [underlying, defaultAdmin, handleViewer]);␊
      ␊
        return { myToken };␊
      });␊
      `,
