...
> Snapshot 1
    ...
    import {FhevmContract} from "@fhevm/solidity@0.8.0/Foo2.sol";␊
    import {FhevmType} from "@fhevm/solidity@0.8.0/Types.sol";␊
    import {ConfidentialContract} from "@openzeppelin/confidential-contracts@0.3.0-rc.0/Foo1.sol";␊
