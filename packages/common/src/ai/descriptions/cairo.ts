...
export const cairoERC20Descriptions = {
  ...
  flashmint: 'Whether to include ERC20FlashMint functionality, allowing flash loans of tokens compliant with ERC-3156.',
  flashMintMaxAmount:
  ...
  flashMintFeeMode:
    "Mode for the flash loan fee. 'percent' charges a percentage of the loaned amount (value provided via flashMintFeePercent). 'custom' emits a TODO stub for the caller to implement.",
  flashMintFeePercent:
    'Percentage of the loan amount charged as the flash loan fee. Number between 0 and 100, fractional values supported (e.g. "0.0013725"). Used when flashMintFeeMode is \'percent\'. Defaults to 0 (no fee).',
