...
export const solidityCommonDescriptions = {
  ...
  namespacePrefix:
    'The prefix for namespace ids. Should be based on the project name or a naming convention unique to the project. Only used if the contract has storage variables and upgradeability is enabled. Default is "myProject"',
};
