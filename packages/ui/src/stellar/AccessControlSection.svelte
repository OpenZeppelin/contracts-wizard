...
>
  <div class="checkbox-group">
    <label class:checked={access === 'ownable'}>
      ...
      Ownable
      <HelpTooltip link="https://docs.openzeppelin.com/stellar-contracts/access/ownable">
    ...
    <label class:checked={access === 'roles'}>
      ...
      Roles
      <HelpTooltip link="https://docs.openzeppelin.com/stellar-contracts/access/access-control">
