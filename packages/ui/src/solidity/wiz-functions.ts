...
const repeatedOptions = {
  ...
  mintable: {
    type: "boolean",
    description:
      "Whether privileged accounts will be able to create more supply or emit more tokens",
  },
};
  ...
  parameters: {
    ...
    properties: {
      ...
      incremental: {
        type: "boolean",
        description:
          "Whether new tokens will be automatically assigned an incremental id",
      },
      // 'false' gets converted to false
      votes: {
        type: "string",
  ...
  parameters: {
    ...
    properties: {
      ...
      updatableUri: {
        type: "boolean",
        description:
          "Whether privileged accounts will be able to set a new URI for all token types",
      },
      ...commonOptions,
    },
    required: ["name", "uri"],
  ...
  parameters: {
    ...
    properties: {
      ...
      upgradeable: {
        ...
        enum: ["false"],
        description:
          "Upgradeability is not yet available for features that use @openzeppelin/community-contracts",
      },
    },
    required: ["name", "symbol"],
  },
  ...
  parameters: {
    ...
    properties: {
      ...
      delay: {
        type: "string",
        description:
          'The delay since proposal is created until voting starts, default is "1 day"',
      },
      period: {
        type: "string",
        description:
          'The length of period during which people can cast their vote, default is "1 week"',
      },
      blockTime: {
        type: "number",
      ...
      proposalThreshold: {
        type: "number",
        description:
          "Minimum number of votes an account must have to create a proposal, default is 0.",
      },
      decimals: {
        type: "number",
        description:
      ...
      quorumPercent: {
        type: "number",
        description:
          "The percent required, in cases of quorumMode equals percent",
      },
      // gets converted to a string to follow the API
      quorumAbsolute: {
        type: "number",
        description:
          "The absolute quorum required, in cases of quorumMode equals absolute",
      },
      votes: {
        type: "string",
