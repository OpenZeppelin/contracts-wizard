...
const ERC20_READ_MORE =
  ' <a class="light-link" href="https://docs.optimism.io/stack/interop/superchain-erc20#requirements" target="_blank" rel="noopener noreferrer">Read more.</a>';
...
export const superchainERC20TooltipProps: { [prop: string]: string | boolean } = {
  ...
  content: superchainGenericTooltipProps.content + ERC20_READ_MORE,
};
