<script lang="ts">
  import type { OptionsErrorMessages } from '@openzeppelin/wizard-stylus';
  import type { RoyaltyInfoOptions } from '@openzeppelin/wizard-stylus/src';
  import HelpTooltip from '../common/HelpTooltip.svelte';
  import { royaltyInfoDefaults } from '@openzeppelin/wizard-stylus';
