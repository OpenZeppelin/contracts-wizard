...
<div class="absolute bottom-8 right-8">
  ...
  <div class={`${showing ? '' : ''} absolute flex flex-col-reverse max-h-[829px] gap-3 overflow-y-auto right-0 bottom-[4.5rem] border-0 shadow-xl bg-gray-50 p-4 rounded-md w-80 animate-fade-up`}>
