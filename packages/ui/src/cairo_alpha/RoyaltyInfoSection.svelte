<script lang="ts">
  import type { OptionsErrorMessages } from '@openzeppelin/wizard-cairo-alpha';
  import type { RoyaltyInfoOptions } from '@openzeppelin/wizard-cairo-alpha/src';
...
<ExpandableCheckbox
  ...
  helpLink="https://docs.openzeppelin.com/contracts-cairo/alpha/api/token_common#ERC2981Component"
...
>
  ...
  <label class="labeled-input">
    <span class="flex justify-between pr-2">
      Fee Denominator
      <HelpTooltip
        link="https://docs.openzeppelin.com/contracts-cairo/alpha/api/token_common#ERC2981Component-IC-FEE_DENOMINATOR"
      >
