<script lang="ts">
  import type { Access } from '@openzeppelin/wizard-cairo-alpha';
...
>
  <div class="checkbox-group">
    <label class:checked={access === 'ownable'}>
      ...
      Ownable
      <HelpTooltip link="https://docs.openzeppelin.com/contracts-cairo/alpha/access#ownership_and_ownable">
    ...
    <label class:checked={access === 'roles'}>
      ...
      Roles
      <HelpTooltip link="https://docs.openzeppelin.com/contracts-cairo/alpha/access#role_based_accesscontrol">
