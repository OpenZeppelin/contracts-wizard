...
<section class="controls-section">
  ...
  <div class="checkbox-group">
    ...
    <label class:checked={opts.burnable}>
      ...
      Burnable
      <HelpTooltip link="https://docs.openzeppelin.com/contracts/5.x-rc/api/token/erc1155#ERC1155Burnable">
    ...
    <label class:checked={opts.updatableUri}>
      ...
      Updatable URI
      <HelpTooltip link="https://docs.openzeppelin.com/contracts/5.x-rc/api/token/erc1155#ERC1155-_setURI-string-">
