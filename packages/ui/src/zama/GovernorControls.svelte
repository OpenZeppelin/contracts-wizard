<script lang="ts">
  ...
  import { governor, infoDefaults } from '@openzeppelin/wizard-zama';
  ...
  <div class="checkbox-group">
    ...
    <label class:checked={opts.timelock === 'compound'}>
      ...
      <HelpTooltip link="https://github.com/compound-finance/compound-protocol/blob/master/contracts/Timelock.sol">
        Module compatible with Compound's <code>Timelock</code> contract. Useful if assets and roles are already held in
        this contract.
      </HelpTooltip>
    </label>
  </div>
