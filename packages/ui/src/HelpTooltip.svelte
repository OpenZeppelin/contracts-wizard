...
<Tooltip interactive placement="right" theme="light-yellow border" maxWidth="15em">
  <svg slot="trigger" class="tooltip" style="width:1rem;height:1rem;" viewBox="0 0 24 24">
