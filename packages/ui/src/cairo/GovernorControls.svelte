  ...
  <label class="labeled-input" for="quorum-input">
    <span class="flex justify-between pr-2">
      <span>
        ...
        <label
          ># <input type="radio" bind:group={opts.quorumMode} value="absolute" on:change={focusQuorumAbsolute} /></label
        >
      </span>
...
<section class="controls-section">
  ...
  <div class="checkbox-group">
    <label class:checked={opts.votes === 'erc20votes'}>
      ...
      ERC20Votes
      <HelpTooltip link="https://docs.openzeppelin.com/contracts-cairo/4.x/api/governance#VotesComponent">
...
<section class="controls-section">
  ...
  <div class="checkbox-group">
    <label class:checked={opts.clockMode === 'timestamp'}>
      ...
      Timestamp
      <HelpTooltip>The token uses voting durations expressed as timestamps.</HelpTooltip>
    </label>
  </div>
</section>
...
>
  <div class="checkbox-group">
    <label class:checked={opts.timelock === 'openzeppelin'}>
      ...
      TimelockController
      <HelpTooltip link="https://docs.openzeppelin.com/contracts-cairo/4.x/api/governance#TimelockControllerComponent">
...
<section class="controls-section">
  <h1>
    ...
    <label class="flex justify-between items-center tooltip-container pr-2">
      ...
      <HelpTooltip>Metadata for the SNIP12 domain separator.</HelpTooltip>
    </label>
  </h1>
