...
<ExpandableCheckbox
  ...
  helpLink="https://docs.openzeppelin.com/contracts-cairo/3.x/api/token_common#ERC2981Component"
...
>
  ...
  <label class="labeled-input">
    <span class="flex justify-between pr-2">
      Fee Denominator
      <HelpTooltip
        link="https://docs.openzeppelin.com/contracts-cairo/3.x/api/token_common#ERC2981Component-IC-FEE_DENOMINATOR"
      >
