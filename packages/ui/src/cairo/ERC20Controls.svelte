<script lang="ts">
  ...
  import type { FlashMintOptions, KindedOptions, OptionsErrorMessages } from '@openzeppelin/wizard-cairo';
  import { premintPattern, erc20, flashMintDefaults, infoDefaults, macrosDefaults } from '@openzeppelin/wizard-cairo';
...
<section class="controls-section">
  ...
  <div class="checkbox-group">
    <label class:checked={opts.mintable}>
      ...
      Mintable
      <HelpTooltip link="https://docs.openzeppelin.com/contracts-cairo/4.x/guides/erc20-supply">
