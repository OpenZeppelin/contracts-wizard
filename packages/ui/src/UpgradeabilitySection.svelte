...
<section class="controls-section">
  ...
  <div class="checkbox-group">
    <label class:checked={upgradeable === 'transparent'}>
      ...
      Transparent
      <HelpTooltip link="https://docs.openzeppelin.com/contracts/5.x-rc/api/proxy#TransparentUpgradeableProxy">
    ...
    <label class:checked={upgradeable === 'uups'}>
      ...
      UUPS
      <HelpTooltip link="https://docs.openzeppelin.com/contracts/5.x-rc/api/proxy#UUPSUpgradeable">
