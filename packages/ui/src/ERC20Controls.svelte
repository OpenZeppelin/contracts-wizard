...
<section class="controls-section">
  ...
  <div class="checkbox-group">
    ...
    <label class:checked={opts.burnable}>
      ...
      Burnable
      <HelpTooltip link="https://docs.openzeppelin.com/contracts/5.x-rc/api/token/erc20#ERC20Burnable">
    ...
    <label class:checked={opts.permit || opts.votes}>
      ...
      Permit
      <HelpTooltip link="https://docs.openzeppelin.com/contracts/5.x-rc/api/token/erc20#ERC20Permit">
    ...
    <label class:checked={opts.flashmint}>
      ...
      Flash Minting
      <HelpTooltip link="https://docs.openzeppelin.com/contracts/5.x-rc/api/token/erc20#ERC20FlashMint">
