...
> Snapshot 1
    ...
    ␊
        #[constructor]␊
        fn constructor(ref self: ContractState, defaultAdmin: ContractAddress, pauser: ContractAddress) {␊
            self.erc20.initializer('MyToken', 'MTK');␊
...
> Snapshot 1
    ...
    ␊
        ...
        fn constructor(ref self: ContractState, recipient: ContractAddress, owner: ContractAddress) {␊
            ...
            self.ownable.initializer(owner);␊
    ␊
            self.erc20._mint(recipient, 2000);␊
        }␊
    ␊
        #[external(v0)]␊
        impl ERC20Impl of IERC20<ContractState> {␊
    ...
    ␊
        #[external(v0)]␊
        impl SafeAllowanceImpl of ISafeAllowance<ContractState> {␊
    ...
    ␊
        #[external(v0)]␊
        impl SafeAllowanceCamelImpl of ISafeAllowanceCamel<ContractState> {␊
